...
.breadcrumb-content{display:inline-flex;flex-direction:row;align-items:center;justify-content:space-between;font-size:14px;color:#323338;color:var(--secondary-text-color);padding:0px 2px;overflow:hidden;text-decoration:none}.breadcrumb-content .breadcrumb-text{color:inherit;margin:0 4px;line-height:22px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.breadcrumb-content .breadcrumb-icon{height:14px;width:14px;flex-shrink:0}.breadcrumb-content:focus{outline:none}.breadcrumb-content.clickable:hover,.breadcrumb-content:focus-within{background-color:#c5c7d0;background-color:var(--primary-background-hover-color);border-radius:4px}.breadcrumb-content.current{color:#323338;color:var(--primary-text-color);font-weight:500}.breadcrumb-content.disabled{border-color:#e6e9ef;border-color:var(--disabled-background-color);color:#676879;color:var(--disabled-text-color);cursor:not-allowed;pointer-events:none}.breadcrumb-content.disabled:hover{background-color:rgba(0,0,0,0)}.breadcrumb-content{font-family:var(--font-family)}
.breadcrumbItem--wrapper{display:inline-flex;overflow:hidden;list-style-type:none;cursor:default}.breadcrumbItem--wrapper.clickable{cursor:pointer}.breadcrumbItem--wrapper.disabled{cursor:not-allowed}

/*# sourceMappingURL=BreadcrumbItem.css.map*/