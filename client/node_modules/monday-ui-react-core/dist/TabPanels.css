...
.tab-panels--wrapper .tab-panel{display:none}.tab-panels--wrapper .tab-panel.animation-direction-rtl{transform:translateX(8px)}.tab-panels--wrapper .tab-panel.animation-direction-ltr{transform:translateX(-8px)}.tab-panels--wrapper .tab-panel.active{display:block;animation:panel-slide-in var(--motion-productive-long) forwards var(--motion-timing-enter)}@keyframes panel-slide-in{100%{transform:translateX(0%)}}

/*# sourceMappingURL=TabPanels.css.map*/