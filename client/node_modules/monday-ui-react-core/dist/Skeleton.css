...
.components-Skeleton-Skeleton-module__fullWidth--IsiP5{width:100%}.monday-style-skeleton:not(.components-Skeleton-Skeleton-module__fullWidth--IsiP5) .monday-style-skeleton_text{width:162px}.monday-style-skeleton:not(.components-Skeleton-Skeleton-module__fullWidth--IsiP5) .monday-style-skeleton_circle{width:40px}.monday-style-skeleton:not(.components-Skeleton-Skeleton-module__fullWidth--IsiP5) .monday-style-skeleton_rectangle{width:160px}
.monday-style-skeleton{display:flex}.monday-style-skeleton_rectangle{height:160px;background:#e6e9ef;background:var(--disabled-background-color);border-radius:4px;overflow:hidden}.monday-style-skeleton_rectangle::before{display:inline-block;content:"";opacity:.1;background-image:linear-gradient(90deg, transparent 0%, var(--placeholder-color) 30%, var(--placeholder-color) 70%, transparent 100%);width:300%;height:300%;margin-bottom:20px;animation-duration:1.2s;animation-fill-mode:forwards;animation-iteration-count:infinite;animation-name:shine;animation-timing-function:var(--motion-timing-enter)}@keyframes shine{0%{transform:translateX(-100%)}50%{transform:translateX(100%)}100%{transform:translateX(100%)}}.monday-style-skeleton_circle{height:40px;background:#e6e9ef;background:var(--disabled-background-color);border-radius:50%;overflow:hidden}.monday-style-skeleton_circle::before{display:inline-block;content:"";opacity:.1;background-image:linear-gradient(90deg, transparent 0%, var(--placeholder-color) 30%, var(--placeholder-color) 70%, transparent 100%);width:300%;height:300%;margin-bottom:20px;animation-duration:1.2s;animation-fill-mode:forwards;animation-iteration-count:infinite;animation-name:shine;animation-timing-function:var(--motion-timing-enter)}@keyframes shine{0%{transform:translateX(-100%)}50%{transform:translateX(100%)}100%{transform:translateX(100%)}}.monday-style-skeleton_text{background:#e6e9ef;background:var(--disabled-background-color);border-radius:4px;overflow:hidden}.monday-style-skeleton_text::before{display:inline-block;content:"";opacity:.1;background-image:linear-gradient(90deg, transparent 0%, var(--placeholder-color) 30%, var(--placeholder-color) 70%, transparent 100%);width:300%;height:300%;margin-bottom:20px;animation-duration:1.2s;animation-fill-mode:forwards;animation-iteration-count:infinite;animation-name:shine;animation-timing-function:var(--motion-timing-enter)}@keyframes shine{0%{transform:translateX(-100%)}50%{transform:translateX(100%)}100%{transform:translateX(100%)}}.monday-style-skeleton_text--h1{height:32px}.monday-style-skeleton_text--h2{height:24px}.monday-style-skeleton_text--h3{height:24px}.monday-style-skeleton_text--h4{height:21px}.monday-style-skeleton_text--h5{height:16px}.monday-style-skeleton_text--h6{height:12px}.monday-style-skeleton_text--small,.monday-style-skeleton_text--custom{height:12px}
