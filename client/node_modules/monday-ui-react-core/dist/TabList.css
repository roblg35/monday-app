...
.tabs--wrapper{padding-bottom:20px}.tabs--wrapper .tabs-list{display:flex;flex-direction:row;list-style-type:none;font-size:0;position:relative;height:40px;outline:none;font-family:var(--font-family)}.tabs--wrapper .tabs-list.sm{height:32px}.tabs--wrapper .tabs-list.lg{height:48px}.tabs--wrapper.stretched .tabs-list{width:100%}.tabs--wrapper.stretched .tabs-list_tab--wrapper{width:100%}.tabs--wrapper.stretched .tabs-list_tab--wrapper_tab-inner{width:100%}.tabs--wrapper.disabled{opacity:0;height:0;padding-bottom:5px;pointer-events:none}.tabs--wrapper.disabled .tabs-list .tab--wrapper .tab-inner:hover{cursor:default}
