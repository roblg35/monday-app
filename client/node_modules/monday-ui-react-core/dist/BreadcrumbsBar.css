...
.breadcrumbs-bar--wrapper ol{display:flex;flex-direction:row;align-items:center;white-space:nowrap}.breadcrumbs-bar--wrapper ol .sparatorIcon{color:#323338;color:var(--secondary-text-color);flex-shrink:0}

/*# sourceMappingURL=BreadcrumbsBar.css.map*/