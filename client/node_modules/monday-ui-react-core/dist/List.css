...
.list-item{display:flex;align-items:center;padding:8px 16px;color:var(--primary-text-color);border-radius:4px;font-size:14px;line-height:18px;font-weight:400;cursor:pointer}.list-item:focus-visible,.list-item.focus-visible{outline:none;z-index:11;border-radius:4px;box-shadow:0 0 0 3px rgba(0,132,255,.5) inset,0 0 0 1px var(--primary-hover-color) inset}.list-item:focus:not(.focus-visible){outline:none}.list-item:hover{background-color:var(--primary-background-hover-color)}.list-item--disabled{cursor:not-allowed;color:var(--disabled-text-color)}.list-item--disabled:hover{background-color:rgba(0,0,0,0)}.list-item--selected{background-color:var(--primary-selected-color)}.list-item--selected:hover{background-color:var(--primary-selected-color)}.list-item--small{height:32px}.list-item--medium{height:40px}.list-item--large{height:48px}.list-item{font-family:var(--font-family)}
.list-title{color:#323338;color:var(--primary-text-color);-webkit-font-smoothing:var(--font-smoothing-webkit);-moz-osx-font-smoothing:var(--font-smoothing-moz);font:var(--font-h5);padding:var(--spacing-medium) var(--spacing-medium) var(--spacing-small);border-radius:var(--border-radius-small)}
...
.monday-style-list{margin:0;padding:0;overflow:auto}.monday-style-list::-webkit-scrollbar{width:4px;height:6px}.monday-style-list::-webkit-scrollbar-thumb{background-color:var(--ui-border-color);border-radius:4px}
