...
export declare const getByTestId: (rootElement: HTMLElement, dataTestId: string) => HTMLElement;
export declare const getAllByTestId: (rootElement: HTMLElement, dataTestId: string) => HTMLElement[];
export declare const getByPlaceholderText: (rootElement: HTMLElement, text: string) => HTMLElement;
export declare const getAllByPlaceholderText: (rootElement: HTMLElement, text: string) => HTMLElement[];
...
export declare const getByRole: (rootElement: HTMLElement, role: string) => HTMLElement;
export declare const getAllByRole: (rootElement: HTMLElement, role: string) => HTMLElement[];
export declare const getByLabelText: (rootElement: HTMLElement, text: string) => HTMLElement;
export declare const getAllByLabelText: (rootElement: HTMLElement, text: string) => HTMLElement[];
export declare const getByText: (rootElement: HTMLElement, text: string) => HTMLElement;
export declare const getAllByText: (rootElement: HTMLElement, text: string) => HTMLElement[];
