...
export declare enum ComboboxOptionIconType {
    DEFAULT = "default",
    RENDERER = "renderer"
}
...
export interface IComboboxOptionEvents {
    onOptionClick: (event: React.MouseEvent | React.KeyboardEvent, index: number, option: IComboboxOption, mouseTriggered: boolean) => void;
