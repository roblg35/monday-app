...
.list-item-icon{display:flex;align-items:center;color:var(--primary-text-color)}.list-item-icon--start{margin-right:var(--spacing-small)}.list-item-icon--end{margin-left:var(--spacing-small)}

/*# sourceMappingURL=ListItemIcon.css.map*/